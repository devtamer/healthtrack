...
mock_data = os.path.join(script_dir, "mock_data")
...
# load all mock data
with open(os.path.join(mock_data, 'patients.json')) as patients:
    patient_data = json.load(patients)

with open(os.path.join(mock_data, 'physicians.json')) as physicians:
    physician_data = json.load(physicians)

with open(os.path.join(mock_data, 'lab_orders.json')) as labs:
